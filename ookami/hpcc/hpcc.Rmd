...
LArename <- list(
  "Ookami; cray,libsci,fftw-cray,mvapich"="Ookami, LibSci",
  "Ookami; gcc,armpl,mvapich"="Ookami, ARMPL",
  "Ookami; gcc,openblas,fftw-rd,mvapich"="Ookami, OpenBLAS",
  "Stampede2-SKX; icc,mkl,intel-mpi"="Stampede2-SKX, MKL"
)
dgemm$config <- recode(dgemm$config,!!!LArename)
dgemm$config <- factor(dgemm$config,levels = rev(c("Ookami, LibSci","Ookami, ARMPL","Ookami, OpenBLAS","Stampede2-SKX, MKL")))
dgemm$average <- dgemm$average / 1000
dgemm$stdev <- dgemm$stdev / 1000
dgemm$tflops <- 57.6
dgemm$tflops[grepl("Stampede2",dgemm$config)] <- 44.8
